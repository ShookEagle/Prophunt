...
internal class ChatColorUtils {
  public static readonly char[] AvailableColors = {
  ...
  public static readonly char[] AllColors = {
  ...
  public static bool IsValidColor(char color, bool allColors = false) {
    return allColors ?
      AllColors.Contains(color) :
      AvailableColors.Contains(color);
  }

  public static bool IsValidColor(string color, bool allColors = false) {
    return allColors ?
      AllColors.Contains(StringToColor(color)) :
      AvailableColors.Contains(StringToColor(color));
  }
